...
function PopupCloseButton({ onClick }: { onClick: () => void }) {
  return (
    <button
      ...
      className="focus-visible:ring-ring hover:bg-muted text-foreground absolute top-1 right-1 z-10 inline-flex size-7 cursor-pointer items-center justify-center rounded-sm transition-colors focus:outline-none focus-visible:ring-2"
    >
...
function ControlButton({
  ...
  return (
    <button
      ...
      type="button"
      className={cn(
        "flex size-10 items-center justify-center transition-all",
...
type MapRouteProps = {
  ...
  /** Line color as CSS color value (default: "rgb(252 76 2)") */
  color?: string;
...
type MapArcProps<T extends MapArcDatum = MapArcDatum> = {
  ...
  * defaults (`line-color: rgb(252 76 2)`, `line-width: 2`, `line-opacity: 0.85`).
...
> = {
  ...
  /** Colors for cluster circles: [small, medium, large] based on point count (default: ["rgb(41 181 111)", "rgb(246 174 49)", "rgb(252 76 2)"]) */
  clusterColors?: [string, string, string];
  /** Point count thresholds for color/size steps: [medium, large] (default: [100, 750]) */
  clusterThresholds?: [number, number];
  /** Color for unclustered individual points (default: "rgb(64 167 255)") */
  pointColor?: string;
...
>({
  ...
  clusterMaxZoom = 14,
  clusterRadius = 50,
  clusterColors = ["rgb(41 181 111)", "rgb(246 174 49)", "rgb(252 76 2)"],
  clusterThresholds = [100, 750],
  pointColor = "rgb(64 167 255)",
  onPointClick,
  onClusterClick,
  ...
  useEffect(() => {
    ...
    map.addLayer({
      ...
      paint: {
        ...
        "circle-stroke-color": "rgb(248 247 243)",
        "circle-opacity": 0.85,
      },
    });
